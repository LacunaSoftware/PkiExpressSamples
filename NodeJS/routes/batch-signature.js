...
router.post('/start', (req, res, next) => {
	...
	Promise.all([
		...
		signatureStarter.setPdfToSignFromPath(Util.getBatchDocPath(id)),
...
router.post('/complete', (req, res, next) => {
	...
	Promise.all([
		...
		signatureFinisher.setFileToSignFromPath(Util.getBatchDocPath(id)),
