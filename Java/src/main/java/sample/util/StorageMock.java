...
public class StorageMock {
    ...
    /**
     * Returns the verification code associated with the given document, or null if no verification code has been
     * associated with it.
     * @param session
     * @param fileId
     * @return
    ...
    /**
     * Returns the ID of the document associated with a given verification code, or null if no document matcher the
     * given code.
     * @param session
     * @param code
     * @return
