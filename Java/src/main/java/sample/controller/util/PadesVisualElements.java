    ...
    public static PadesVisualRepresentation getVisualRepresentation(int sampleNumber) throws IOException {
        ...
        switch (sampleNumber) {
            ...
            case 1:
                ...
                // Create an instance of PadesVisualAutoPositioning class. This class will create a custom auto
                // positioning for the visual representation.
                PadesVisualAutoPositioning position = new PadesVisualAutoPositioning();
                // Set the page number. Negative values represent pages counted form the end of the document (-1 is the
                // last page)
                position.setPageNumber(-1);
                // Set the row spacing between signatures. The signatures will be placed in the container side by side.
                // If there's no room left, the signatures will "wrap" to the next row. This value specifies the
