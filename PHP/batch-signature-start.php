 ...
 * signed. It receives the ID of the document and the signer's certificate content and initiates a
 * PAdES signature using PKI Express and returns a JSON with the parameters for the client-side
...
// Get the parameters for this signature (received from the POST call via AJAX, see
...
// Set visual representation. We provide a PHP class that represents the visual representation
// model.
...
// Respond this request with the fields received from start() method to be used on the javascript or
