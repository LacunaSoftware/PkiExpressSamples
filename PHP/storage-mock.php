...
function getVerificationCode($fileId)
{
    ...
    // >>>>> NOTICE <<<<<
    // This should be implemented on your application as a SELECT on your "document table" by the ID
    // of the document, returning the value of the verification code column.
...
function setVerificationCode($fileId, $code)
{
    ...
    // >>>>> NOTICE <<<<<
    // This should be implemented on your application as a UPDATE on your "document table" filling
