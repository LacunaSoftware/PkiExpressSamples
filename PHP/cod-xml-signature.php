...
<div class="container">
    ...
    <p>
        This sample performs two signature on the same XML document, one on each element, according to the standard <i>Certificación de Origen Digital</i> (COD), from
        <i>Asociación Latinoamericano de Integración</i> (ALADI). For more information, please see standard (in
        <a href="http://www.aladi.org/nsfweb/Documentos/2327Rev2.pdf" target="_blank">Spanish</a> or in
        <a href="http://www.mdic.gov.br/images/REPOSITORIO/secex/deint/coreo/2014_09_19_-_Brasaladi_761_-_Documento_ALADI_SEC__di_2327__Rev_2_al_port_.pdf" target="_blank">Brazilian Portuguese</a>).
    </p>
