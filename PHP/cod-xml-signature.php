...
/*
 * This file only renders the COD XML signature initial page. This sample will perform two signatures on the same XML
 * document, one on each element, according to the standard Certificación de Origen Digital (COD), from Asociación
...
<div class="container">
    ...
    <p>
        This sample performs two signature on the same XML document, one on each element, according to the standard <i>Certificación de Origen Digital</i> (COD),
        from <i>Asociación Latinoamericano de Integración</i> (ALADI). For more information, please see standard (in <a href="http://www.aladi.org/nsfweb/Documentos/2327Rev2.pdf" target="_blank">Spanish</a>
