...
/*
 * This file performs the first of the two signatures on the COD element of the document. After the signature, it will
 * render the links to download the signed file and to perform the second signature (on the CODEH element).
 */
    ...
    <?php if ($state != 'completed') { ?>
        ...
        <form id="signForm" action="cod-xml-signature-sign-cod.php" method="POST">
            ...
            <div class="form-group">
                ...
                <p>You are signing the <i>COD</i> element of <a href='content/SampleCodEnvelope.xml'>this sample COD XML envelope</a>.</p>
            </div>
