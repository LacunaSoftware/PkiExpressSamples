...
/*
 * This file performs the first of the two signatures on the COD element of the document. After the
 * signature, it will render the links to download the signed file and to perform the second
 * signature (on the CODEH element).
 */
...
if ($state == 'start') {
    ...
    try {
        ...
        // Get an instance of the XmlSignatureStarter class, responsible for receiving the signature
        ...
        $signatureStarter->setXmlToSign('content/SampleCodEnvelope.xml');
    ...
    if ($state == 'complete') {
        ...
        try {
            ...
            $signatureFinisher->setFileToSign('content/SampleCodEnvelope.xml');
...
<div class="container">
    ...
    <?php if ($state != 'completed') { ?>
        ...
        ?>
        <form id="signForm" action="cod-xml-signature-sign-cod.php" method="POST">
            ...
            <div class="form-group">
                ...
                <p>You are signing the <i>COD</i> element of <a href='content/SampleCodEnvelope.xml'>this sample COD XML envelope</a>.
                </p>
            </div>
    ...
    <?php // This page is shown when the signature is completed with success. ?>
        ...
        <p>
            <a href="cod-xml-signature-sign-codeh.php?userfile=<?= $outputFile ?>" class="btn btn-primary">Sign CODEH element</a>
            <a href="app-data/<?= $outputFile ?>" class="btn btn-default">Download XML with signed COD element</a>
        </p>
