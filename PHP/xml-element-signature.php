...
/*
 * This file perform a XML signature of an element of the XML in three steps using PKI Express and
 * Web PKI.
 */
    ...
    <?php if ($state != 'completed') { ?>
        ...
        <form id="signForm" action="xml-element-signature.php" method="POST">
            ...
            <div class="form-group">
                ...
                <p>You are signing the <i>infNFe</i> node of
                    <a href='content/SampleNFe.xml'>this sample XML</a>.</p>
            </div>
