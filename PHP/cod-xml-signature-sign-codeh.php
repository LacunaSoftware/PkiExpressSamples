...
/*
 * This file performs the second of the two signatures on the CODEH element of the document. After
 * the signature, it will render a link to download the signed file.
 */
...
// cod-xml-signature-sign-cod.php, this is the "COD (Certificacíon de Origen Digital) XML signature"
...
if ($state == 'start') {
    ...
    try {
        ...
        // but with the "COD" element already sign on cod-xml-signature-sign-cod.php file.
