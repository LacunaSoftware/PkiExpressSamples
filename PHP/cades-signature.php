...
if (!empty($userfile)) {
    ...
    // upload.php (signature with file uploaded by user). We'll set the path of the file to be
...
if ($state == 'start') {
    ...
    try {
        ...
        // Get an instance of the CadesSignatureStarter class, responsible for receiving the
        ...
        // Set file to be signed. If the file is a CMS, PKI Express will recognize that and will
        // co-sign that file.
...
<div class="container">
    ...
    <?php
    // This section will be only shown if some error has occurred in the last signature attempt. If
    // the user start a new signature, this error message is cleared.
    ?>
    ...
    <?php if ($state != 'completed') { ?>
        ...
        <form id="signForm" action="cades-signature.php" method="POST">
            ...
            <?php } else { ?>
                <p>You'll are signing <a href='content/SampleDocument.pdf'>this sample document</a>.
                </p>
            <?php } ?>
